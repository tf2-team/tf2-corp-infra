...
# Override via env: $env:OPENSEARCH_ADMIN_USER, $env:OPENSEARCH_ADMIN_PASSWORD
# Password MUST be alphanumeric, length >= 24 (OpenSearch requirement).
# Do NOT use the placeholder below for production — set OPENSEARCH_ADMIN_PASSWORD env var.
