...
# already has two per-log-group subscription filters.
...
addons = {
  ...
  "coredns" = {
    ...
    configuration_values = "{\"nodeSelector\":{\"workload-class\":\"critical\"},\"resources\":{\"requests\":{\"cpu\":\"100m\",\"memory\":\"70Mi\"},\"limits\":{\"cpu\":\"200m\",\"memory\":\"256Mi\"}}}"
  }
  "kube-proxy" = {
    addon_version        = "v1.36.0-eksbuild.9"
    configuration_values = "{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"64Mi\"},\"limits\":{\"cpu\":\"250m\",\"memory\":\"256Mi\"}}}"
  }
  "aws-ebs-csi-driver" = {
    # Pin controller only; ebs-csi-node DaemonSet stays universal (no workload-class selector).
    configuration_values = "{\"controller\":{\"nodeSelector\":{\"workload-class\":\"critical\"},\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}},\"node\":{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}},\"sidecars\":{\"attacher\":{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}},\"livenessProbe\":{\"resources\":{\"requests\":{\"cpu\":\"5m\",\"memory\":\"20Mi\"},\"limits\":{\"cpu\":\"100m\",\"memory\":\"64Mi\"}}},\"nodeDriverRegistrar\":{\"resources\":{\"requests\":{\"cpu\":\"5m\",\"memory\":\"20Mi\"},\"limits\":{\"cpu\":\"100m\",\"memory\":\"64Mi\"}}},\"provisioner\":{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}},\"resizer\":{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}},\"snapshotter\":{\"resources\":{\"requests\":{\"cpu\":\"10m\",\"memory\":\"40Mi\"},\"limits\":{\"cpu\":\"500m\",\"memory\":\"256Mi\"}}}}}"
  }
}
