...
> Repository này chịu trách nhiệm chính về việc khởi tạo hạ tầng Terraform (Bootstrap), cấu hình Remote State (S3 & KMS), provisioning EKS Cluster/VPC/ECR, và cung cấp IAM Role/Helm command cho AWS Load Balancer Controller.
