...
`accounting`, `ad`, `aiops`, `cart`, `checkout`, `currency`, `email`, `fraud-detection`, `frontend`, `frontend-proxy`, `image-provider`, `load-generator`, `mem0`, `payment`, `product-catalog`, `product-reviews`, `quote`, `recommendation`, `shipping`, `shopping-copilot`, `flagd-ui`, `kafka`, `llm`, `opensearch`
